"""
Parser de malla PS2 de DBZ Budokai (B1/B2/B3/IW comparten formato) basado en
el MaxScript budokai_updated.ms.
...
def parse_amg(b, amg_off, base):
    ...
    AMG header (verificado en bin real PS2):
...
def main():
    ...
    if magic not in (b'#AMO', b'#AMO0'):
        ...
        return
    # header del AMO0 (verificado en bin real PS2):
